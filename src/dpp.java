...
public class dpp extends JFrame {
	...
	public dpp() {
		...
		setTitle("Eliminar un pedido cancelado");
		...
		JLabel lblDatosDelCliente = new JLabel("Pedido Cancelado");
		...
		btnComprobar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				for (int i = 0; i < parsex.arraypp.length; i++) {
					if (cdct.equals(parsex.arraypp[i][0])) {
						ciftest = 2;
					}
					if (parsex.arraypp[i][0] == null) {
						i = parsex.arraypp.length;
					}
				}
