...
public class dpro extends JFrame {
	...
	public dpro() {
		...
		JLabel lblDatosDelCliente = new JLabel("Baja de un proveedor");
		...
		btnComprobar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (ciftest == 0) {
					JOptionPane.showMessageDialog(null, "No existe ningun proveedor con el codigo que intentas eliminar");
				}
				if (ciftest == 2) {
