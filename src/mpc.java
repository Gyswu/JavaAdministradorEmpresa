...
public class mpc extends JFrame {
	...
	public mpc() throws IOException {
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				sql order = new sql();
				order.mpc(cp, fecha, mpt, dirt, cdct, all);
		...
		btnCargar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				for (int i = 0; i < parsex.arraypc.length; i++) {
					if (cp.equals(parsex.arraypc[i][0])) {
						ciftest++;
						...
						mp.setText(parsex.arraypc[i][2]);
						dir.setText(parsex.arraypc[i][3]);
						cdc.setText(parsex.arraypc[i][4]);
						tt.setText(parsex.arraypc[i][5]);
